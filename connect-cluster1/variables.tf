...
variable "binaries" {
  default = {
    kube-apiserver = "https://artifacts.schubergphilis.com/artifacts/base_images/kubernetes/kube-apiserver"
    kube-controller-manager = "https://artifacts.schubergphilis.com/artifacts/base_images/kubernetes/kube-controller-manager"
    kube-scheduler = "https://artifacts.schubergphilis.com/artifacts/base_images/kubernetes/kube-scheduler"
    kube-proxy = "https://artifacts.schubergphilis.com/artifacts/base_images/kubernetes/kube-proxy"
    kube-kubelet = "https://artifacts.schubergphilis.com/artifacts/base_images/kubernetes/kubelet"
  }
}
